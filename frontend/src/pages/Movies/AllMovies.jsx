        ...
        <section>
          ...
          >
            ...
            <div className="relative z-10 text-center text-white mt-[10rem]">
              <h1 className="text-8xl font-bold mb-4">The Movies Mate</h1>
...
<select
  ...
  value={moviesFilter.selectedYear || ""}  // Ensure a scalar value (string)
...
<select
  className="border p-2 rounded ml-4 text-black"
  value={moviesFilter.selectedSort || ""}  // Ensure a scalar value (string)
