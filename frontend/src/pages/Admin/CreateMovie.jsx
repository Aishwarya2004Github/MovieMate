...
const CreateMovie = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "genre") {
      const selectedGenre = genres.find((genre) => genre._id === value); // Make sure to match with _id
      setMovieData((prevData) => ({
        ...prevData,
        genre: selectedGenre ? selectedGenre._id : "", // Update with _id
      }));
    } else {
      setMovieData((prevData) => ({
        ...prevData,
        ...
        <form>
          ...
          <div className="mb-4">
            <label className="block">
              ...
              <select
  name="genre"
  value={movieData.genre} // Ensure this matches with movieData.genre (which is _id)
  onChange={handleChange}
...
>
  {isLoadingGenres ? (
    ...
    genres.map((genre) => (
      <option key={genre._id} value={genre._id}> {/* Ensure _id is used */}
        {genre.name}
      </option>
    ))
  ) : (
          ...
          <div className="mb-4">
            ...
            >
              ...
              <input
                ...
                style={{color:"white", display: !selectedImage ? "none" : "block" }}
              />
            </label>
          </div>
