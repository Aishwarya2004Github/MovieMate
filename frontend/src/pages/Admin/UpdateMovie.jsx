...
import Sidebar from "./Dashboard/Sidebar/Sidebar"; // Import Sidebar
...
const UpdateMovie = () => {
  ...
  return (
    <div className="flex overflow-x-hidden"> {/* Prevent horizontal scroll */}
      {/* Sidebar on the left */}
      <Sidebar />

      {/* Main content section */}
      <div className="container flex justify-center items-center mt-4 w-full pl-64 max-w-full overflow-x-hidden">
